...
namespace OpendxpVendureBridgeBundle\EventListeners;

use JetBrains\PhpStorm\ArrayShape;
use OpenDxp\Event\Model\DataObjectEvent;
use OpendxpVendureBridgeBundle\Model\OpendxpVendureInterface;
use OpendxpVendureBridgeBundle\Service\AmqpService;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;

class OpendxpVendureListener implements EventSubscriberInterface
{
    ...
    /**
     * @param \OpendxpVendureBridgeBundle\Service\AmqpService $amqpService
     */
    ...
    public function onPostUpdate(DataObjectEvent $event): void
    {
        ...
        if (!$object instanceof OpendxpVendureInterface || $this->skipPushToQueue) {
            return;
        }
