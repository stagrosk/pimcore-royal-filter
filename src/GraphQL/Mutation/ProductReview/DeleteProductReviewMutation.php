...
use App\GraphQL\Type\Arguments\ProductReview\DeleteProductReviewArgs;
use JetBrains\PhpStorm\ArrayShape;
use Pimcore\Bundle\DataHubBundle\Event\GraphQL\Model\MutationTypeEvent;

class DeleteProductReviewMutation extends AbstractMutation
{
    ...
    public function onPreBuild(MutationTypeEvent $event): array
    {
        return [
            'type' => $this->response,
            'args' => DeleteProductReviewArgs::args(),
            'resolve' => [$this->resolver, 'deleteReview'],
        ];
    }
