...
use App\GraphQL\Type\Arguments\Review\AddReplyArgs;
use JetBrains\PhpStorm\ArrayShape;
use Pimcore\Bundle\DataHubBundle\Event\GraphQL\Model\MutationTypeEvent;

class AddReplyMutation extends AbstractMutation
{
    ...
    public function onPreBuild(MutationTypeEvent $event): array
    {
        return [
            'type' => $this->response,
            'args' => AddReplyArgs::args(),
            'resolve' => [$this->resolver, 'addReply'],
        ];
    }
