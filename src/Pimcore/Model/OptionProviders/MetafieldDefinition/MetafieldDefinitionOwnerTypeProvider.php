...
class MetafieldDefinitionOwnerTypeProvider implements SelectOptionsProviderInterface
{
    public function getOptions(array $context, Data $fieldDefinition): array
    {
        $result = [];
        $ownerTypes = MetafieldOwnerTypeEnum::getValues();
        foreach ($ownerTypes as $ownerTypeValue) {
            $result[] = [
                'key' => $ownerTypeValue,
