 ...
 * Fields Summary:
 * - status [select]
 * - hotTubRef [manyToOneRelation]
 * - hotTubBrand [input]
 * - hotTubModel [input]
 * - yearOfManufacture [input]
 * - volume [input]
 * - jets [input]
 * - dimensionsLength [input]
 * - dimensionsWidth [input]
 * - dimensionsHeight [input]
 * - hotTubNote [textarea]
 * - originalLabel [input]
 * - filterHeight [input]
 * - filterDiameter [input]
 * - filterNote [textarea]
 * - topType [select]
 * - topHoleDiameter [input]
 * - topThreadOuterDiameter [input]
 * - topThreadInnerDiameter [input]
 * - topThreadPitch [input]
 * - topThreadRibHeight [input]
 * - topStubDescription [textarea]
 * - bottomType [select]
 * - bottomHoleDiameter [input]
 * - bottomThreadOuterDiameter [input]
 * - bottomThreadInnerDiameter [input]
 * - bottomThreadPitch [input]
 * - bottomThreadRibHeight [input]
 * - bottomStubDescription [textarea]
 * - email [input]
 * - phone [input]
 * - photos [imageGallery]
 * - adminNote [textarea]
