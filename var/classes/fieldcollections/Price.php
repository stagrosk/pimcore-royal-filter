 ...
 * - applyDiscountPercentage [numeric]
 */
          ...
          \OpenDxp\Model\DataObject\ClassDefinition\Layout\Fieldset::__set_state(array(
            ...
            array (
              ...
              \OpenDxp\Model\DataObject\ClassDefinition\Data\Numeric::__set_state(array(
                 ...
                 'tooltip' => 'MOC price before discount (Standard price)',
                 'mandatory' => false,
                 'noteditable' => false,
                 'index' => false,
                 'locked' => false,
            ...
            array (
              ...
              \OpenDxp\Model\DataObject\ClassDefinition\Layout\Text::__set_state(array(
                ...
                array (
                 ...
                 'fieldtype' => 'text',
                 'html' => '<div class="alert alert-info">Zľava je spočítaná z price, vypočíta novu cenu a pôvodnú cenu dá do compareAtPrice, ak sa zmení zľava a už existuje compareAtPrice tak vypočíta novú cenu z compareAtPrice. Ak sa zľava zruší tak sa compareAtPrice nuluje a dáva sa pôvodná cena.</div>',
                 'renderingClass' => '',
                 'renderingData' => '',
                 'border' => false,
              )),
              1 => 
              \OpenDxp\Model\DataObject\ClassDefinition\Data\Numeric::__set_state(array(
                 'name' => 'applyDiscountPercentage',
                 'title' => 'Apply Discount Percentage',
                 'tooltip' => 'Automatically calculate from price the new price by discount and move original price to compareAtPrice',
                 'mandatory' => false,
                 'noteditable' => false,
                 'index' => false,
                 'locked' => false,
